...
export default function MenCollectionPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        // Fetch products
        const response = await fetch('/api/products?category=cat-006');
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading men&#39;s collection...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            {language === 'en' 
              ? 'Discover our premium collection of artificial jewelry designed exclusively for men' 
              : 'पुरुषों के लिए विशेष रूप से डिज़ाइन किए गए हमारे प्रीमियम कृत्रिम आभूषणों के संग्रह की खोज करें'}
          </p>
        </div>
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
            {language === 'en' ? 'All Men\'s Products' : 'सभी पुरुष उत्पाद'}
          </h2>
                    ...
                    <div className="relative h-48 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                      <Image
                        ...
                        onError={(e: any) => {
                          ...
                          target.src = '/images/mens product/placeholder.jpg';
                        }}
                      />
              ...
              {products.map(product => (
                <div key={product.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                  <div className="relative">
                    <Image
                      src={product.productImages[0]?.url || product.images[0] || '/images/mens product/placeholder.jpg'}
