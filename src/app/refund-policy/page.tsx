...
export default function RefundPolicyPage() {
  ...
  const translations = {
    en: {
      ...
      intro: 'At Pachmarhi Tribal Art Marketplace, we want you to be completely satisfied with your purchase. If for any reason you are not satisfied, we\'re here to help.',
      policySections: [
        {
          title: 'Return Policy',
          content: `
      ...
      contactInfo: {
        ...
        email: 'support@pachmarhi.com',
        phone: '+91 98765 43210',
        hours: 'Monday to Saturday, 9:00 AM to 6:00 PM IST'
      }
    },
    hi: {
      title: 'वापसी और धनवापसी',
      intro: 'पचमढ़ी जनजातीय कला बाजार में, हम चाहते हैं कि आप पूरी तरह से अपनी खरीदारी से संतुष्ट हों। यदि किसी कारण से आप संतुष्ट नहीं हैं, तो हम यहां मदद करने के लिए हैं।',
      policySections: [
        {
          title: 'वापसी नीति',
          content: `
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            <div className="p-6 md:p-8 space-y-10">
              {t.policySections.map((section, index) => (
